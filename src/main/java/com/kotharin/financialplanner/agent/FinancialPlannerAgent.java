        ...
        return LlmAgent.builder()
                ...
                .instruction(
                        """
                                    ...
                                    After showing the Potfoio to the user, ask the user if they have any concentrated positions. If they have a concentrated position, ask for the date they acquired it.and use the analyzeConcentratedPosition tool to analyze the concentrated position and show the user the analysis.
                                    Do not add any more data than returned in the analyisis.
